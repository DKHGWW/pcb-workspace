...
const DEFAULT_CONFIG = {
  langText: {
    zh: {
      ...
      overview: {
        products: "产品技术",
        products_desc: "井明电子产品技术体系覆盖网络通信、汽车电子、智能终端、工控医疗、电源、消费电子等多个应用领域。请从下拉菜单选择“涉及领域”，点击后查看该领域的典型产品。",
        news: "新闻中心",
      ...
      about_detail: {
        intro: "公司简介",
        intro_text: "四川井明电子有限公司始创于2011年，前身为遂宁豪尔思电子科技有限公司，整合宏安兴盛、豪尔思电子深耕行业近二十年之积淀，坐落于遂宁国家经济技术开发区电子电路产业园。公司现有员工400余人，标准化厂房面积40,000余平方米，月生产能力10万平方米。\n\n公司专业从事双面及多层高精密HDI、高难度印制线路板的研发、设计、精密生产与配套服务，产品广泛应用于计算机、数据通讯、商业航天、汽车电子、消费类电子、电讯业、AI智能等相关生产企业，远销欧美日韩等国内外市场，服务客户200余家，覆盖30余个地区。企业资质齐全，拥有IATF16949、ISO9001、ISO14001、UL、CQC权威认证，产品符合RoHS环保标准。\n\n公司秉承“诚信、创新、效率、协作、共享”的经营理念，倡导“优质服务、客户满意、互惠互利、持续发展”的价值理念，坚持以人为本、培训考核、激发潜能，致力于不断提高顾客满意度，打造PCB业界特色名牌企业。",
        stats: [
          { value: "40,000⁺ ㎡", label: "厂房面积" },
          { value: "10 万㎡", label: "月生产能力" },
          { value: "400⁺ 人", label: "员工人数" },
          { value: "200⁺ 家", label: "服务客户" }
        ],
        capability: "制程能力",
        capability_table: {
      ...
      products_detail: {
        spec_labels: { type: "产品类型", layer: "产品层次", material: "产品材料", copper: "铜厚", application: "应用领域" },
        items: [
          { id: "uav", title: "无人机用8层HDI板", image: "images/products/prod-uav.jpg", tags: ["智能汽车", "航空航天"], specs: { type: "沉金+osp+树脂塞孔+盲埋孔工艺", layer: "8层", material: "生益S1000 TG170", copper: "3/3", application: "无人机" } },
          { id: "optical1", title: "光模块用2层沉镍钯金板", image: "images/products/prod-optical1.jpg", tags: ["光模通讯"], specs: { type: "沉镍钯金工艺", layer: "2层", material: "FR-4 0.9mm 1/1OZ TG135", copper: "1/1", application: "光模块" } },
          { id: "optical2", title: "通讯产品展示——4边半孔光模块板", image: "images/products/prod-optical2.jpg", tags: ["光模通讯"], specs: { type: "沉金+4边半孔工艺", layer: "4层", material: "FR-4 0.8mm TG150", copper: "1/1", application: "光模块" } },
          { id: "charging", title: "高压快充用2层板", image: "images/products/prod-charging.jpg", tags: ["智能汽车"], specs: { type: "无铅喷锡工艺", layer: "2层", material: "FR-4 1.5mm TG135", copper: "3/3", application: "高压快充" } },
          { id: "power", title: "电源主板用2层板", image: "images/products/prod-power.jpg", tags: ["消费电子"], specs: { type: "无铝喷锡工艺", layer: "2层", material: "FR-4 1.9mm TG135", copper: "2/2", application: "电源主板" } },
          { id: "ai_server", title: "AI服务器用6层板", image: "images/products/prod-ai_server.jpg", tags: ["AI服务"], specs: { type: "沉金+背钻+树脂塞孔工艺", layer: "6层", material: "生益S1000-2M 1.6mm TG170", copper: "2/2", application: "AI服务器" } },
          { id: "medical", title: "精密医疗仪器主板", image: "images/products/prod-medical.jpg", tags: ["医疗器械"], specs: { type: "沉金工艺", layer: "4层", material: "FR4 0.8mm TG135", copper: "2/2OZ", application: "精密医疗仪器主板" } },
          { id: "ssd", title: "移动固态硬盘用2层板", image: "images/products/prod-ssd.jpg", tags: ["消费电子"], specs: { type: "OSP工艺", layer: "2层", material: "FR4 0.9mm TG135", copper: "1/1OZ", application: "移动固态硬盘" } }
        ]
      },
      news_detail: {
        company_news: "公司新闻",
    ...
    en: {
      ...
      overview: {
        ...
        products_desc: "Kinming's product technology spans telecom, automotive, smart devices, industrial & medical, power and consumer electronics. Choose 'Fields Served' from the dropdown, then click a field to see its typical products.",
        news: "News Center",
      ...
      about_detail: {
        ...
        intro_text: "Sichuan Kinming Electronics Co., Ltd. was founded in 2011 (formerly Suining Haoersi Electronic Technology Co., Ltd.), integrating nearly two decades of industry expertise from Hong'an Xingsheng and Haoersi. Located in Suining National Economic and Technological Development Zone Electronic Circuit Industrial Park, we have over 400 employees, 40,000⁺ m² standardized factory space and monthly capacity of 100,000 m².\n\nWe specialize in R&D, design, precision production and supporting services of double-sided and multilayer high-precision HDI and high-difficulty PCBs. Our products are widely used in computers, data communications, commercial aerospace, automotive electronics, consumer electronics, telecommunications, AI and related industries, exported to Europe, America, Japan, Korea and other markets, serving 200+ customers across 30+ regions. We hold IATF16949, ISO9001, ISO14001, UL, CQC and other certifications, with RoHS-compliant products.\n\nUpholding the business philosophy of \"Integrity, Innovation, Efficiency, Collaboration, Sharing\" and the value concept of \"Quality Service, Customer Satisfaction, Mutual Benefit, Sustainable Development\", we are committed to improving customer satisfaction and building a distinctive brand in the PCB industry.",
        stats: [
          { value: "40,000⁺ m²", label: "Plant Area" },
          { value: "100k m²", label: "Monthly Capacity" },
      ...
      products_detail: {
        spec_labels: { type: "Product Type", layer: "Layer Count", material: "Material", copper: "Copper Thickness", application: "Application" },
        items: [
          { id: "uav", title: "8-Layer HDI PCB for UAVs", image: "images/products/prod-uav.jpg", tags: ["Automotive", "Aerospace"], specs: { type: "ENIG + OSP + resin plug + blind/buried via", layer: "8 layers", material: "Shengyi S1000 TG170", copper: "3/3", application: "UAVs" } },
          { id: "optical1", title: "2-Layer ENIG-Pd PCB for Optical Modules", image: "images/products/prod-optical1.jpg", tags: ["Optical Communication"], specs: { type: "Electroless nickel-palladium-gold", layer: "2 layers", material: "FR-4 0.9mm 1/1OZ TG135", copper: "1/1", application: "Optical modules" } },
          { id: "optical2", title: "Communication Product Display — 4-side Half-hole Optical Module PCB", image: "images/products/prod-optical2.jpg", tags: ["Optical Communication"], specs: { type: "ENIG + 4-side half-hole", layer: "4 layers", material: "FR-4 0.8mm TG150", copper: "1/1", application: "Optical modules" } },
          { id: "charging", title: "2-Layer PCB for High-voltage Fast Charging", image: "images/products/prod-charging.jpg", tags: ["Automotive"], specs: { type: "Lead-free HASL", layer: "2 layers", material: "FR-4 1.5mm TG135", copper: "3/3", application: "High-voltage fast charging" } },
          { id: "power", title: "2-Layer PCB for Power Main Board", image: "images/products/prod-power.jpg", tags: ["Consumer Electronics"], specs: { type: "Aluminum-free HASL", layer: "2 layers", material: "FR-4 1.9mm TG135", copper: "2/2", application: "Power main board" } },
          { id: "ai_server", title: "6-Layer PCB for AI Servers", image: "images/products/prod-ai_server.jpg", tags: ["AI Server"], specs: { type: "ENIG + backdrill + resin plug", layer: "6 layers", material: "Shengyi S1000-2M 1.6mm TG170", copper: "2/2", application: "AI servers" } },
          { id: "medical", title: "Precision Medical Instrument Main Board", image: "images/products/prod-medical.jpg", tags: ["Medical Devices"], specs: { type: "ENIG", layer: "4 layers", material: "FR4 0.8mm TG135", copper: "2/2OZ", application: "Precision medical instrument main board" } },
          { id: "ssd", title: "2-Layer PCB for Mobile SSD", image: "images/products/prod-ssd.jpg", tags: ["Consumer Electronics"], specs: { type: "OSP", layer: "2 layers", material: "FR4 0.9mm TG135", copper: "1/1OZ", application: "Mobile SSD" } }
        ]
      },
      news_detail: {
  ...
  carouselData:   {
      about: {
          zh: [
              { image: "images/carousel/factory-gate.jpg", title: "井明电子", desc: "四川井明电子有限公司——专业化高可靠PCB制造企业" },
              { image: "images/carousel/smt-workshop.jpg", title: "洁净车间", desc: "万级无尘车间，高精度PCB生产线" },
          ],
          en: [
              { image: "images/carousel/factory-gate.jpg", title: "Kinming Electronics", desc: "Sichuan Kinming Electronics — professional high-reliability PCB manufacturer" },
              { image: "images/carousel/smt-workshop.jpg", title: "Clean Workshop", desc: "Class-10000 cleanroom with high-precision PCB lines" },
          ],
      },
      industry: {
          zh: [
